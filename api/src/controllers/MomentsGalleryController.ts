...
import { MomentsGalleryService, MomentsItemInput } from '../services/MomentsGalleryService';

export class MomentsGalleryController {
  constructor(private service = new MomentsGalleryService()) {}
  ...
  create = async (_req: Request, res: Response, next: NextFunction) => {
    try {
      const body = res.locals.body as MomentsItemInput;
